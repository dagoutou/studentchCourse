...
<!-- Loading Flat UI JS -->
<script type="text/javascript" src="/Coursesel/utils/scripts/flat-ui.min.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form name="studentquery" action="/Coursesel/AdminHandler/query1/1" method="get">
					<div class="row">
						<div class="col-md-4">
				...
				<table class="table table-striped table-hover animated fadeIn">
					...
					<c:forEach var="course" items="${requestScope.courseList}">
						<tr>
							...
							<td><a class="btn btn-default" href="/Coursesel/AdminHandler/moditystuc/${course.cid}">
									修改 </a></td>

							<td><a class="btn btn-default" class="deleteCss"
								href="/Coursesel/AdminHandler/delete1/${course.cid}"> 删除 </a></td>
						</tr>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/Coursesel/CourseHandler/query/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/Coursesel/CourseHandler/query/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/Coursesel/CourseHandler/query/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/Coursesel/CourseHandler/query/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
...
<script type="text/javascript" src="/Coursesel/utils/scripts/flat-ui.js"></script>
<script src="/Coursesel/utils/scripts/bganimation.js"></script></body>
</html>