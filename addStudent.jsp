...
<script type="text/javascript">
	 $(document).ready(
			function() {
				$("#sid").change(
						function() {
							$.post("/Coursesel/AjaxHandler/existSid?sid="
...
<body><div id="particles-js"><canvas class="particles-js-canvas-el" width="1322" height="774" style="width: 100%; height: 100%;"></canvas></div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h5>添加学生</h5>
				<form action="${pageContext.request.contextPath}/AdminHandler/addStudent" method="post" name="form1">
					<div class="row">
						<div class="col-md-6">
							<h6>学号</h6>
...
<%--							</select>--%>
							<input type="text" name="profession" class="form-control" maxlength="6" id="belongcoll"></input>
...
<%--							</select>--%>
							<input type="text" name="college" class="form-control" maxlength="10" id="belongpro"></input>
...
<%--							</select>--%>
							<input type="text" name="classr" class="form-control" maxlength="10" id="belongcla"></input>
...
<script type="text/javascript" src="/Coursesel/utils/scripts/flat-ui.js"></script><script src="/Coursesel/utils/scripts/bganimation.js"></script>
