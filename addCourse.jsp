...
<script type="text/javascript">
	 $(document).ready(
			function() {
				$("#cid").change(
						function() {
							$.post("/Coursesel/AjaxHandler/existCid?cid="
...
<script type='text/javascript' src='/Coursesel/utils/scripts/particles.js'></script><link href="/StudentInfo/utils/css/animate.css" rel="stylesheet"></head>
<body><div id="particles-js"><canvas class="particles-js-canvas-el" width="1322" height="774" style="width: 100%; height: 100%;"></canvas></div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h5>添加课程</h5>
				<form action="${pageContext.request.contextPath}/CourseHandler/addCourse" method="post" name="form1">
					<h6>课程编号</h6>
...
<%--					</select>--%>
					<input type="text" name="type" class="form-control" maxlength="20"></input>
...
<%--						--%>
<%--					</select>--%>
					<input type="text" name="belongcoll" class="form-control" maxlength="20" id="belongcoll"></input>
...
<%--						--%>
<%--					</select> --%>
					<input type="text" name="belongpro" class="form-control" maxlength="20" id="belongpro"></input>
